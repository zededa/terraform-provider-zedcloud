...
- `acls` (Block List, Min: 1) app Acls (see [below for nested schema](#nestedblock--interfaces--acls))
- `directattach` (Boolean) direct attach flag
- `eidregister` (Block List, Min: 1) EID register details (see [below for nested schema](#nestedblock--interfaces--eidregister))
- `intfname` (String) intf Name
- `intforder` (Number) intforder
- `io` (Block List, Min: 1) Physical Adapter to be matched for interface assignment. Applicable only when "direct attach" flag is true (see [below for nested schema](#nestedblock--interfaces--io))
...
- `actions` (Block List, Min: 1) app ACE actions (see [below for nested schema](#nestedblock--interfaces--acls--actions))
- `matches` (Block List, Min: 1) app ACE match (see [below for nested schema](#nestedblock--interfaces--acls--matches))
...
- `mapparams` (Block List, Min: 1) Application map params (see [below for nested schema](#nestedblock--interfaces--acls--actions--mapparams))
