...
- `description` (String)
- `disable_v_t_p_m` (Boolean)
- `display_name` (String)
- `docker_compose_tar_image_name` (String)
- `docker_compose_yaml_text` (String)
- `enable_oem_win_license_key` (Boolean)
- `enablevnc` (Boolean)
...
- `persistent_runtime_size_bytes` (String)
...
### Nested Schema for `cloud_policy.network_policy.net_instance_config.edge_node_cluster`
...
### Nested Schema for `module_policy.network_policy.net_instance_config.edge_node_cluster`
