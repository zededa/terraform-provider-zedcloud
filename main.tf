...
resource "zedcloud_image"  "test_tf_provider" {
  name = "test_tf_provider"
  title = "test_tf_provider"
  image_arch = data.zedcloud_image.test_tf_provider.image_arch
  image_format = data.zedcloud_image.test_tf_provider.image_format
  datastore_id = data.zedcloud_image.test_tf_provider.datastore_id
  image_rel_url = "test_url"
  image_size_bytes = 0
  project_access_list = [data.zedcloud_project.test_tf_provider.id]
  image_type = data.zedcloud_image.test_tf_provider.image_type
}

data "zedcloud_image"  "test_tf_provider" {
  name = "test_tf_provider"
  title = "test_tf_provider"
  image_format = "bfa12a79-7dc8-4639-8909-882e8c44eaf4"
...
resource "zedcloud_patch_envelope" "test_tf_provider" {
  ...
  artifacts {
    ...
    binary_artifact {
      image_id = data.zedcloud_image.test_tf_provider.id
      image_name = data.zedcloud_image.test_tf_provider.name
