...
import (
	...
	apiclient "github.com/zededa/zedcloud-api/client"
	"github.com/zededa/zedcloud-api/resources/utils"
	"github.com/hashicorp/terraform-plugin-sdk/v2/helper/schema"
	zschema "github.com/zededa/zedcloud-api/schema"
)
...
func {{ $operation }}(ctx context.Context, d *schema.ResourceData, m interface{}) diag.Diagnostics {
	...
	// limit output to a single result
		...
		zschema.Set{{- pascalize $operationGroup -}}ResourceData(d, result)
	}
	{{- else }}
