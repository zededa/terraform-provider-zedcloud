...
//
// - EVENT_SOURCE_UNSPECIFIED: Default - EVENT_SOURCE_SYSTEM: Event is generated as a result of status change reported by edge node / application - EVENT_SOURCE_USER: Event is generated as a result of an user's configuration action
//
