...
func appInstFullCfg() *swagger_models.AppInstance {
	return &swagger_models.AppInstance{
		...
		AppID:              utils.StrPtr("Sample App ID"),
				...
				&swagger_models.CustomConfigVariableGroup{
					...
					Variables: []*swagger_models.VariableGroupVariable{
						&swagger_models.VariableGroupVariable{
							...
							Label:     utils.StrPtr("Sample label"),
							MaxLength: "10",
							Name:      utils.StrPtr("Sample VGV Name"),
		...
		DeviceID: utils.StrPtr("Sample Device ID"),
		Drives: []*swagger_models.Drive{
			&swagger_models.Drive{
				Cleartext:   true,
				Drvtype:     utils.StrPtr("CDROM"),
				Ignorepurge: true,
				Imagename:   utils.StrPtr("SampleImageName"),
				Imvolname:   "",
				Maxsize:     nil,
				...
				Preserve:    true,
				Readonly:    true,
				Target:      utils.StrPtr("Sample Target"),
		...
		Interfaces: []*swagger_models.AppInterface{
			&swagger_models.AppInterface{
					...
					&swagger_models.AppACE{
						...
						Matches: []*swagger_models.AppACEMatch{
							&swagger_models.AppACEMatch{
								Type:  utils.StrPtr("matchType"),
								Value: utils.StrPtr("matchValue"),
							},
						},
						Name: utils.StrPtr("Sample ACL Name"),
					},
				},
				DefaultNetInstance: true,
				Directattach:       true,
				Intfname:           utils.StrPtr("eth10"),
				...
				Ipaddr:      utils.StrPtr("10.1.1.220"),
				Macaddr:     utils.StrPtr("a.1.2"),
				Netinstname: utils.StrPtr("Sample Network Instance"),
