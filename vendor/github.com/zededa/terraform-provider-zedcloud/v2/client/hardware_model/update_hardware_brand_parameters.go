...
func (o *HardwareModelUpdateHardwareBrandParams) WithBody(body *models.SysBrand) *HardwareModelUpdateHardwareBrandParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the hardware model update hardware brand params
func (o *HardwareModelUpdateHardwareBrandParams) SetBody(body *models.SysBrand) {
	o.Body = body
}
