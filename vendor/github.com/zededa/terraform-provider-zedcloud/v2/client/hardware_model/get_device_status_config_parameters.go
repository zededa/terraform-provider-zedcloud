...
// WithDeviceName adds the deviceName to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) WithDeviceName(deviceName *string) *HardwareModelGetDeviceStatusConfigParams {
	o.SetDeviceName(deviceName)
	return o
}

// SetDeviceName adds the deviceName to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) SetDeviceName(deviceName *string) {
...
// WithLoad adds the load to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) WithLoad(load *string) *HardwareModelGetDeviceStatusConfigParams {
	o.SetLoad(load)
	return o
}

// SetLoad adds the load to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) SetLoad(load *string) {
	o.Load = load
}

// WithNamePattern adds the namePattern to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) WithNamePattern(namePattern *string) *HardwareModelGetDeviceStatusConfigParams {
	o.SetNamePattern(namePattern)
	return o
}

// SetNamePattern adds the namePattern to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) SetNamePattern(namePattern *string) {
...
// WithProjectName adds the projectName to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) WithProjectName(projectName *string) *HardwareModelGetDeviceStatusConfigParams {
	o.SetProjectName(projectName)
	return o
}

// SetProjectName adds the projectName to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) SetProjectName(projectName *string) {
	o.ProjectName = projectName
}

// WithProjectNamePattern adds the projectNamePattern to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) WithProjectNamePattern(projectNamePattern *string) *HardwareModelGetDeviceStatusConfigParams {
	o.SetProjectNamePattern(projectNamePattern)
	return o
}

// SetProjectNamePattern adds the projectNamePattern to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) SetProjectNamePattern(projectNamePattern *string) {
	o.ProjectNamePattern = projectNamePattern
}

// WithRunState adds the runState to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) WithRunState(runState *string) *HardwareModelGetDeviceStatusConfigParams {
	o.SetRunState(runState)
	return o
}

// SetRunState adds the runState to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) SetRunState(runState *string) {
	o.RunState = runState
}
...
// WithTags adds the tags to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) WithTags(tags *string) *HardwareModelGetDeviceStatusConfigParams {
	o.SetTags(tags)
	return o
}

// SetTags adds the tags to the hardware model get device status config params
func (o *HardwareModelGetDeviceStatusConfigParams) SetTags(tags *string) {
	o.Tags = tags
}
