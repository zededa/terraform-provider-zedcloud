...
type IdentityAccessManagementGetAuthProfileByNameOK struct {
	Payload *models.AuthorizationProfile
}
...
func (o *IdentityAccessManagementGetAuthProfileByNameOK) GetPayload() *models.AuthorizationProfile {
	return o.Payload
}
...
func (o *IdentityAccessManagementGetAuthProfileByNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.AuthorizationProfile)
