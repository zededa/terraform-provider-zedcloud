...
type IdentityAccessManagementLogoutOK struct {
	Payload *models.AAAFrontendLogoutResponse
}
...
func (o *IdentityAccessManagementLogoutOK) GetPayload() *models.AAAFrontendLogoutResponse {
	return o.Payload
}
...
func (o *IdentityAccessManagementLogoutOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.AAAFrontendLogoutResponse)
