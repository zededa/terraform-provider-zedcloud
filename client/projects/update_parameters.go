...
func (o *ProjectsUpdateParams) WithBody(body ProjectsUpdateBody) *ProjectsUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the projects update params
func (o *ProjectsUpdateParams) SetBody(body ProjectsUpdateBody) {
	o.Body = body
}
