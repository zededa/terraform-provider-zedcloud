...
func (o *CreateAccepted) Error() string {
	...
	return fmt.Sprintf("[POST /v2/projects/id/{projectId}/deployments][%d] CreateAccepted %s", 202, payload)
}
...
func (o *CreateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v2/projects/id/{projectId}/deployments][%d] CreateUnauthorized %s", 401, payload)
}
...
func (o *CreateForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v2/projects/id/{projectId}/deployments][%d] CreateForbidden %s", 403, payload)
}
...
func (o *CreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v2/projects/id/{projectId}/deployments][%d] CreateInternalServerError %s", 500, payload)
}
...
func (o *CreateGatewayTimeout) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v2/projects/id/{projectId}/deployments][%d] CreateGatewayTimeout %s", 504, payload)
}
...
func (o *CreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v2/projects/id/{projectId}/deployments][%d] ResourceGroup_CreateDeployment default %s", o._statusCode, payload)
}
