...
type ClientService interface {
	...
	HardwareModelDeleteEdgeNode(params *HardwareModelDeleteEdgeNodeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HardwareModelDeleteEdgeNodeOK, error)
...
/*
HardwareModelDeleteEdgeNode deletes pcr template

Delete an pcr template record.
*/
func (a *Client) HardwareModelDeleteEdgeNode(params *HardwareModelDeleteEdgeNodeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*HardwareModelDeleteEdgeNodeOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewHardwareModelDeleteEdgeNodeParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "HardwareModel_DeleteEdgeNode",
		Method:             "DELETE",
		PathPattern:        "/v1/pcrtemplates/id/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &HardwareModelDeleteEdgeNodeReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*HardwareModelDeleteEdgeNodeOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*HardwareModelDeleteEdgeNodeDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
