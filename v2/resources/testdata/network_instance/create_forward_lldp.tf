resource "zedcloud_project" "test_tf_provider" {
    # required
    name = "test_tf_provider-netinst_fwd_lldp_3__SUFFIX__"
    title = "title"
...
resource "zedcloud_datastore"  "test_tf_provider" {
    ...
    name = "test_tf_provider-ds_fwd_lldp_3__SUFFIX__"
    title = "test_tf_provider-ds_fwd_lldp_3__SUFFIX__"
...
resource "zedcloud_image" "test_tf_provider" {
    ...
    name = "test_tf_provider-img_fwd_lldp_3__SUFFIX__"
...
resource "zedcloud_brand" "test_tf_provider" {
    name = "test_tf_provider-brand_fwd_lldp_3__SUFFIX__"
    title = "test_tf_provider-brand_fwd_lldp_3__SUFFIX__"
...
resource "zedcloud_model" "test_tf_provider" {
    ...
    name = "test_tf_provider-model_fwd_lldp_3__SUFFIX__"
    title = "test_tf_provider-model_fwd_lldp_3__SUFFIX__"
    type = "AMD64"
    origin_type = "ORIGIN_LOCAL"
...
resource "zedcloud_edgenode" "test_tf_provider" {
    name = "test_tf_provider-node_fwd_lldp_3__SUFFIX__"
...
resource "zedcloud_network_instance" "test_tf_netinst_forward_lldp" {
    ...
    name = "test_tf_provider-netinst_fwd_lldp_3__SUFFIX__"
    title = "test_tf_provider-netinst_fwd_lldp_3__SUFFIX__"
