...
func DeviceStatusListMsgModel(d *schema.ResourceData) *models.DeviceStatusListMsg {
	list, _ := d.Get("list").([]*models.DeviceStatusSummaryMsg) // []*DeviceStatusSummaryMsg
	...
	totalEdgeviewActiveInt, _ := d.Get("total_edgeview_active").(int)
	totalEdgeviewActive := int64(totalEdgeviewActiveInt)
