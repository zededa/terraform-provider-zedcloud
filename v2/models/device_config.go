...
type Node struct {
	...
	// A list of bond interfaces
	BondAdapter []*BondAdapter `json:"bondAdapter"`
	...
	// PCR policy for TPM key sealing on this specific device (overrides project policy)
	PcrPolicy *Policy `json:"pcrPolicy,omitempty"`
...
func (m *Node) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateBondAdapter(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validatePcrPolicy(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Node) validateBondAdapter(formats strfmt.Registry) error {
	if swag.IsZero(m.BondAdapter) { // not required
		return nil
	}

	for i := 0; i < len(m.BondAdapter); i++ {
		if swag.IsZero(m.BondAdapter[i]) { // not required
			continue
		}

		if m.BondAdapter[i] != nil {
			if err := m.BondAdapter[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("bondAdapter" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("bondAdapter" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *Node) validateConfigLock(formats strfmt.Registry) error {
...
func (m *Node) validateEdgeNodeCluster(formats strfmt.Registry) error {
...
func (m *Node) validateEdgeSyncConfig(formats strfmt.Registry) error {
...
func (m *Node) validateModel(formats strfmt.Registry) error {
...
func (m *Node) validatePcrPolicy(formats strfmt.Registry) error {
	if swag.IsZero(m.PcrPolicy) { // not required
		return nil
	}

	if m.PcrPolicy != nil {
		if err := m.PcrPolicy.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("pcrPolicy")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("pcrPolicy")
			}
			return err
		}
	}
...
func (m *Node) validateProject(formats strfmt.Registry) error {
...
func (m *Node) validateVlanAdapters(formats strfmt.Registry) error {
...
func (m *Node) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateBondAdapter(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidatePcrPolicy(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Node) contextValidateBondAdapter(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.BondAdapter); i++ {
		...
		if m.BondAdapter[i] != nil {
			...
			if err := m.BondAdapter[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("bondAdapter" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("bondAdapter" + "." + strconv.Itoa(i))
...
func (m *Node) contextValidateConfigLock(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Node) contextValidateEdgeNodeCluster(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Node) contextValidateEdgeSyncConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Node) contextValidatePcrPolicy(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.PcrPolicy != nil {
		...
		if err := m.PcrPolicy.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("pcrPolicy")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("pcrPolicy")
...
func (m *Node) contextValidateProject(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Node) contextValidateVlanAdapters(ctx context.Context, formats strfmt.Registry) error {
