...
const (
	...
	// TransCauseTRANSCAUSEAPPENABLEVMCONFIGCHANGED captures enum value "TRANS_CAUSE_APP_ENABLE_VM_CONFIG_CHANGED"
	TransCauseTRANSCAUSEAPPENABLEVMCONFIGCHANGED TransCause = "TRANS_CAUSE_APP_ENABLE_VM_CONFIG_CHANGED"

	// TransCauseTRANSCAUSEAPPCOMPOSETARIMAGECHANGED captures enum value "TRANS_CAUSE_APP_COMPOSE_TAR_IMAGE_CHANGED"
	TransCauseTRANSCAUSEAPPCOMPOSETARIMAGECHANGED TransCause = "TRANS_CAUSE_APP_COMPOSE_TAR_IMAGE_CHANGED"

	// TransCauseTRANSCAUSEAPPCOMPOSEYAMLCHANGED captures enum value "TRANS_CAUSE_APP_COMPOSE_YAML_CHANGED"
	TransCauseTRANSCAUSEAPPCOMPOSEYAMLCHANGED TransCause = "TRANS_CAUSE_APP_COMPOSE_YAML_CHANGED"

	// TransCauseTRANSCAUSEAPPCOMPOSEDATASTORECHANGED captures enum value "TRANS_CAUSE_APP_COMPOSE_DATASTORE_CHANGED"
	TransCauseTRANSCAUSEAPPCOMPOSEDATASTORECHANGED TransCause = "TRANS_CAUSE_APP_COMPOSE_DATASTORE_CHANGED"
)
