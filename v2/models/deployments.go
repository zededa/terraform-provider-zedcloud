...
type Deployments struct {
	...
	// deployment instance summary list response
	List []*DeploymentConfigSummary `json:"list"`

	// cursor next
	Next *Cursor `json:"next,omitempty"`

	// deployment instance by summary
...
func (m *Deployments) validateList(formats strfmt.Registry) error {
...
func (m *Deployments) validateNext(formats strfmt.Registry) error {
...
func (m *Deployments) validateSummaryByState(formats strfmt.Registry) error {
...
func (m *Deployments) contextValidateList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Deployments) contextValidateNext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Deployments) contextValidateSummaryByState(ctx context.Context, formats strfmt.Registry) error {
