...
const (
	...
	// PolicyTypePOLICYTYPEPORTBASEDNETWORKACCESSCONTROL captures enum value "POLICY_TYPE_PORT_BASED_NETWORK_ACCESS_CONTROL"
	PolicyTypePOLICYTYPEPORTBASEDNETWORKACCESSCONTROL PolicyType = "POLICY_TYPE_PORT_BASED_NETWORK_ACCESS_CONTROL"
)
...
func init() {
	var res []PolicyType
	if err := json.Unmarshal([]byte(`["POLICY_TYPE_UNSPECIFIED","POLICY_TYPE_APP","POLICY_TYPE_AZURE","POLICY_TYPE_AWS","POLICY_TYPE_GCP","POLICY_TYPE_MODULE","POLICY_TYPE_ATTESTATION","POLICY_TYPE_NETWORK","POLICY_TYPE_CLUSTER","POLICY_TYPE_EDGEVIEW","POLICY_TYPE_PORT_BASED_NETWORK_ACCESS_CONTROL"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
