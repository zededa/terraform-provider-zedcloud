...
func CertificateEnrollmentDetailModel(d *schema.ResourceData) *models.CertificateEnrollmentDetail {
	certificateEnrollmentDetail := d.Get("certificate_enrollment_detail").(models.CertificateEnrollmentDetail)
...
// Iterate throught and update the CertificateEnrollmentDetail resource data within a pagination response (typically defined in the items array field) retrieved from a READ operation for multiple LM resources
