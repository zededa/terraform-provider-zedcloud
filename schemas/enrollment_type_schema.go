...
func EnrollmentTypeModel(d *schema.ResourceData) *models.EnrollmentType {
	enrollmentType := d.Get("enrollment_type").(models.EnrollmentType)
...
// Iterate throught and update the EnrollmentType resource data within a pagination response (typically defined in the items array field) retrieved from a READ operation for multiple LM resources
