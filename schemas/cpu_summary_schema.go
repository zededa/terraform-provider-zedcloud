...
func CPUSummaryModel(d *schema.ResourceData) *models.CPUSummary {
	utilization := d.Get("utilization").(float64)
...
// Iterate throught and update the CPUSummary resource data within a pagination response (typically defined in the items array field) retrieved from a READ operation for multiple LM resources
